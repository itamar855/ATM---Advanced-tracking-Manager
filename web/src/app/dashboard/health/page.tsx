    ...
    <div className="space-y-6 fade-in max-w-5xl mx-auto pb-12">
      ...
      <div className="glass-card p-5 space-y-4">
        ...
        {loadingAccounts ? (
          ...
          <div className="max-w-md space-y-2">
            ...
            <div className="relative">
              <select
                ...
                disabled={refreshing}
                className="input py-2 text-xs bg-[var(--color-bg-surface)] cursor-pointer appearance-none pr-8"
              >
          ...
          <div className="p-4 rounded-lg bg-[var(--color-bg-primary)] border border-[var(--color-border-subtle)]">
            <p className="text-xs text-[var(--color-text-secondary)] leading-relaxed">
              Nenhuma conta de anúncios conectada encontrada. Acesse a página de{" "}
              <a href="/dashboard/settings/integrations" className="font-bold text-[var(--color-brand-300)] hover:underline">
                Integrações
              </a>{" "}
            ...
            <div className="glass-card p-6 space-y-4">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3">
                {healthData.tier_signals.map((s: any) => (
                  <div
                    key={s.label}
                    className="p-3 rounded-lg bg-[var(--color-bg-primary)]/70 border border-[var(--color-border-subtle)] space-y-2"
                  >
                    <p className="text-[10px] font-semibold text-[var(--color-text-muted)] uppercase tracking-wide leading-tight">
                      {s.label}
                    </p>
