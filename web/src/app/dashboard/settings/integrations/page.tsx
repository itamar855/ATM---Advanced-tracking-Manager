        ...
        <div className="flex items-center justify-between flex-wrap gap-4">
          ...
          <div className="flex items-center gap-2">
            <a
              ...
              className="flex items-center gap-2 px-4 py-2 rounded-lg bg-[#1877F2] hover:bg-[#166fe5] text-white text-xs font-bold transition-all shadow-md"
            >
            ...
            <button
              type="button"
              onClick={() => {
                navigator.clipboard.writeText(`${host}/api/auth/facebook`);
                alert("Link de autorização copiado! Cole no navegador onde seu Facebook de anúncios está aberto.");
              }}
